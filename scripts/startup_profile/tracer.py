#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Function execution tracer for OpenSpider."""
import json
import time
import traceback
...
class ExecTracer:
    """Trace function execution in openspider package."""
...
def main():
    """Run tracer on openspider app import."""
    ...
    tracer = ExecTracer(package_names=["openspider"])
    sys.settrace(tracer.trace_calls)

    try:
        # Import openspider app to trigger startup
        from openspider.app._app import (  # pylint: disable=unused-import
            app,
        )  # noqa: F401
    finally:
        sys.settrace(None)
