# openspider Agent Team Practice Guide

This guide introduces how to build multi-agent collaborative teams using openspider + HiClaw, achieving the capability leap from single Agent to Agent Team.
...
### openspider Team Solution

openspider Team provides a complete multi-Agent orchestration and collaboration solution by combining **openspider** + **[HiClaw](https://hiclaw.io/)**:

- **openspider Team Leader**: Built on openspider, serves as team coordinator, responsible for task decomposition, work allocation, and result aggregation
- **openspider Workers**: Built on openspider, serve as task executors, focusing on domain-specific work, receiving Leader instructions and returning results
...
- [openspider Quick Start](./quickstart)
- [openspider Multi-Agent](./multi-agent)
- [openspider Skills](./skills)
...
openspider Agent Team, through the combination of openspider and HiClaw, provides powerful multi-agent collaboration capabilities for individual developers and small teams. Through proper team design and task allocation, work efficiency can be significantly improved, achieving a "one-person team."
