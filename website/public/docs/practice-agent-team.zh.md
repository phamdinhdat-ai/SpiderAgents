# openspider Agent Team 实践指南

本文档介绍如何使用 openspider + HiClaw 构建多智能体协作团队，实现从单一 Agent 到 Agent Team 的能力跃迁。
...
openspider Team 通过组合 **openspider** + **[HiClaw](https://hiclaw.io/)**，提供完整的多 Agent 编排协作方案：

- **openspider Team Leader**：基于 openspider 构建，担任团队协调者，负责任务分解、工作分配和结果汇总
- **openspider Workers**：基于 openspider 构建，担任任务执行者，专注于特定领域工作，接收 Leader 指令并返回结果
...
- [openspider 快速开始](./quickstart)
- [openspider 多智能体](./multi-agent)
...
openspider Agent Team 通过 openspider 和 HiClaw 的结合，为个人开发者和小型团队提供了强大的多智能体协作能力。通过合理的团队设计和任务分配，可以显著提升工作效率，实现"一个人的团队"。
