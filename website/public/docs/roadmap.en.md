...
| **openspider Custom Models**             | Multimodal model support                                                                                     | Planned              |
...
|                                       | Agent protocol: openspider → openspider                                                                            | In Progress          |
|                                       | Agent protocol: OpenClaw → openspider                                                                           | Planned              |
...
We are building openspider in the open and welcome contributions of all kinds! Check the table above (especially items marked **Seeking Contributors**) to find areas that interest you, and read [CONTRIBUTING](https://github.com/agentscope-ai/openspider/blob/main/CONTRIBUTING.md) to get started. We particularly welcome:
...
Join the conversation on [GitHub Issue - Open Tasks](https://github.com/agentscope-ai/openspider/issues/2291) to suggest or pick up work.
