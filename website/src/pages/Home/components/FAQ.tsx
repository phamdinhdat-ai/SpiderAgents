...
export function FAQ() {
            ...
            <>
              ...
              <ul className="mt-2 list-disc space-y-1 pl-5">
                ...
                <li>
                  ...
                  <code>pip install --upgrade openspider</code>
                </li>
                ...
                <li>
                  ...
                  <ul className="mt-1 list-disc space-y-1 pl-5">
                    ...
                    <li>
                      ...
                      <a
                        href="https://github.com/agentscope-ai/openspider/releases"
                        target="_blank"
          ...
          answer: (
            <>
              <p>
                ...
                <code>openspider init --defaults</code>
              </p>
              <p>
                {t("homeFaq.quickStart.initialize.p2")} <code>openspider app</code>
              </p>
              <p className="mt-2">
          ...
          answer: (
            <>
              ...
              <p className="mt-2">
                ...
                <code>openspider models</code> {t("homeFaq.features.models.p4Mid")}{" "}
                <Link
                  to="/docs/cli#openspider-models"
                  className="text-(--color-primary) no-underline transition hover:brightness-110"
                >
            ...
            <>
              ...
              <ol className="mt-2 list-decimal space-y-1 pl-5">
                ...
                <li>
                  ...
                  <a
                    href="https://github.com/agentscope-ai/openspider/issues"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-(--color-primary) no-underline transition hover:brightness-110"
                  >
                  ...
                  <code>openspider_query_error_qzbx1mv1.json</code>
  ...
  return (
    <motion.section
      ...
      aria-labelledby="openspider-faq-heading"
    >
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 md:grid-cols-[40%_60%] md:gap-12">
          <motion.div variants={itemVariants}>
            <h2 id="openspider-faq-heading" className={sectionStyles.title}>
              {t("homeFaq.title")}
            </h2>
            <p
