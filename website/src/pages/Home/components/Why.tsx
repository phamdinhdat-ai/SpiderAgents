...
export function Why() {
  ...
  const heroLine = t("whyopenspider.heroLine");
  const secondPrefix = t("whyopenspider.secondPrefix");
        ...
        >
          <div className="relative pt-7 md:pt-10">
            ...
            <h2 className="font-newsreader font-semibold relative z-10 text-3xl leading-[0.98] text-[#ffffff] sm:text-[42px] md:text-[52px]">
              <span>{t("whyopenspider.headingPrefix")} </span>
              <span className="inline-block italic whitespace-nowrap">
                {t("whyopenspider.headingEmphasis")}
              </span>
              <svg
                aria-hidden
                viewBox="0 0 360 120"
