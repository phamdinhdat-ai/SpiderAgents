...
def manager(tmp_path):
    ...
    from openspider.agents.memory.agent_md_manager import AgentMdManager
...
class TestAgentMdManagerInit:
    ...
    def test_working_dir_created(self, tmp_path):
        ...
        from openspider.agents.memory.agent_md_manager import (
            AgentMdManager,
        )
...
class TestAgentMdManagerReadWorkingMd:
    ...
    def test_reads_content_via_encoding_fallback(
        ...
        mod = sys.modules["openspider.agents.memory.agent_md_manager"]
        with patch.object(
            mod,
