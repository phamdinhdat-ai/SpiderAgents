...
def qq_channel(mock_process_handler, tmp_path) -> Generator:
    ...
    from openspider.app.channels.qq.channel import QQChannel
...
class TestSanitizeQQText:
    ...
    def test_sanitize_removes_http_urls(self):
        ...
        from openspider.app.channels.qq.channel import _sanitize_qq_text
...
class TestAggressiveSanitizeQQText:
    ...
    def test_aggressive_sanitize_removes_bare_domains(self):
        ...
        from openspider.app.channels.qq.channel import (
...
class TestAsBool:
    ...
    def test_as_bool_true_values(self):
        ...
        from openspider.app.channels.qq.channel import _as_bool
...
class TestIsUrlContentError:
    ...
    def test_is_url_content_error_non_qq_api_error(self):
        ...
        from openspider.app.channels.qq.channel import _is_url_content_error
...
class TestGetNextMsgSeq:
    ...
    def test_get_next_msg_seq_increments(self):
        ...
        from openspider.app.channels.qq.channel import _get_next_msg_seq
...
class TestMakeContentPart:
    ...
    def test_make_image_content(self, qq_channel):
        ...
        from openspider.app.channels.qq.channel import ImageContent
    ...
    def test_make_video_content(self, qq_channel):
        ...
        from openspider.app.channels.qq.channel import VideoContent
    ...
    def test_make_audio_content(self, qq_channel):
        ...
        from openspider.app.channels.qq.channel import AudioContent
    ...
    def test_make_file_content(self, qq_channel):
        ...
        from openspider.app.channels.qq.channel import FileContent
...
class TestWSState:
    ...
    def test_ws_state_defaults(self):
        ...
        from openspider.app.channels.qq.channel import _WSState
...
class TestComputeReconnectDelay:
    ...
    def test_first_reconnect_delay(self, qq_channel):
        ...
        from openspider.app.channels.qq.channel import _WSState, RECONNECT_DELAYS
...
class TestQQApiError:
    ...
    def test_qq_api_error_attributes(self):
        ...
        from openspider.app.channels.qq.channel import QQApiError
...
class TestMediaPath:
    ...
    def test_media_path_c2c(self):
        ...
        from openspider.app.channels.qq.channel import _media_path
...
class TestGetApiBase:
    ...
    def test_get_api_base_from_env(self, monkeypatch):
        ...
        from openspider.app.channels.qq.channel import _get_api_base
...
class TestWSConnectOnce:
    ...
    def test_max_reconnect_attempts_reached(self, qq_channel):
        ...
        with patch(
            "openspider.app.channels.qq.channel._get_channel_url_sync",
...
class TestDownloadQQFile:
    ...
    async def test_download_empty_filename(self, tmp_path):
        ...
        from openspider.app.channels.qq.channel import _download_qq_file
...
class TestSendImages:
    ...
    @pytest.mark.asyncio
    @patch("openspider.app.channels.qq.channel._upload_media_async")
    @patch("openspider.app.channels.qq.channel._send_media_message_async")
...
class TestSendMessageAsync:
    ...
    @pytest.mark.asyncio
    @patch("openspider.app.channels.qq.channel._api_request_async")
    async def test_plain_text(self, mock_api):
        """Should send plain text message."""
        from openspider.app.channels.qq.channel import _send_message_async
