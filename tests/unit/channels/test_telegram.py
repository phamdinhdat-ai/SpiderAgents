...
def telegram_channel(
    ...
    from openspider.app.channels.telegram.channel import TelegramChannel
...
class TestTelegramChannelFromConfig:
    ...
    def test_from_config_with_config_object(
        ...
        from openspider.app.channels.telegram.channel import TelegramChannel
        from openspider.config.config import TelegramConfig
...
class TestTelegramSendMediaValue:
    ...
    async def test_send_media_value_file_not_found(
        ...
        from openspider.app.channels.telegram.channel import (
...
class TestTelegramMessageMeta:
    ...
    def test_message_meta_full(self):
        ...
        from openspider.app.channels.telegram.channel import _message_meta
...
class TestTelegramExceptions:
    ...
    def test_file_too_large_error(self):
        ...
        from openspider.app.channels.telegram.channel import _FileTooLargeError
