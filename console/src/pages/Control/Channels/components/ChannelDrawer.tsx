...
// Doc EN URLs per channel (anchors on https://openspider.agentscope.io/docs/channels)
const CHANNEL_DOC_EN_URLS: Partial<Record<ChannelKey, string>> = {
  dingtalk:
    "https://openspider.agentscope.io/docs/channels/?lang=en#DingTalk-recommended",
  feishu: "https://openspider.agentscope.io/docs/channels/?lang=en#Feishu-Lark",
  imessage:
    "https://openspider.agentscope.io/docs/channels/?lang=en#iMessage-macOS-only",
  discord: "https://openspider.agentscope.io/docs/channels/?lang=en#Discord",
  qq: "https://openspider.agentscope.io/docs/channels/?lang=en#QQ",
  telegram: "https://openspider.agentscope.io/docs/channels/?lang=en#Telegram",
  mqtt: "https://openspider.agentscope.io/docs/channels/?lang=en#MQTT",
  mattermost: "https://openspider.agentscope.io/docs/channels/?lang=en#Mattermost",
  matrix: "https://openspider.agentscope.io/docs/channels/?lang=en#Matrix",
  sip: "https://openspider.agentscope.io/docs/channels/?lang=en#SIP",
  wecom:
    "https://openspider.agentscope.io/docs/channels/?lang=en#WeCom-WeChat-Work",
  wechat:
    "https://openspider.agentscope.io/docs/channels/?lang=en#WeChat-Personal-iLink",
  xiaoyi:
    "https://developer.huawei.com/consumer/cn/doc/service/openclaw-0000002518410344",
  onebot:
    "https://openspider.agentscope.io/docs/channels/?lang=en#OneBot-v11-NapCat--QQ-full-protocol",
};

// Doc ZH URLs per channel (anchors on https://openspider.agentscope.io/docs/channels)
const CHANNEL_DOC_ZH_URLS: Partial<Record<ChannelKey, string>> = {
  dingtalk: "https://openspider.agentscope.io/docs/channels/?lang=zh#钉钉推荐",
  feishu: "https://openspider.agentscope.io/docs/channels/?lang=zh#飞书",
  imessage:
    "https://openspider.agentscope.io/docs/channels/?lang=zh#iMessage仅-macOS",
  discord: "https://openspider.agentscope.io/docs/channels/?lang=zh#Discord",
  qq: "https://openspider.agentscope.io/docs/channels/?lang=zh#QQ",
  telegram: "https://openspider.agentscope.io/docs/channels/?lang=zh#Telegram",
  mqtt: "https://openspider.agentscope.io/docs/channels/?lang=zh#MQTT",
  mattermost: "https://openspider.agentscope.io/docs/channels/?lang=zh#Mattermost",
  matrix: "https://openspider.agentscope.io/docs/channels/?lang=zh#Matrix",
  sip: "https://openspider.agentscope.io/docs/channels/?lang=zh#SIP",
  wecom: "https://openspider.agentscope.io/docs/channels/?lang=zh#企业微信",
  wechat: "https://openspider.agentscope.io/docs/channels/?lang=zh#微信个人iLink",
  xiaoyi:
    "https://developer.huawei.com/consumer/cn/doc/service/openclaw-0000002518410344",
  onebot:
    "https://openspider.agentscope.io/docs/channels/?lang=zh#OneBot-v11NapCat--QQ-完整协议",
};
      ...
      case "wechat":
        return (
          <>
            ...
            >
              <Input placeholder="~/.openspider/wechat_bot_token" />
            </Form.Item>
            <Form.Item name="media_dir" label={t("channels.wechatMediaDir")}>
              <Input placeholder={defaultMediaDir} />
            </Form.Item>
