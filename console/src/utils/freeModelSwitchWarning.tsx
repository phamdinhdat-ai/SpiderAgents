...
const FREE_MODEL_WARNING_DISABLED_KEY =
  "openspider_free_model_switch_warning_disabled";
    ...
    Modal.confirm({
      ...
      content: (
        <div>
          ...
          <div className="openspider-free-model-warning-link-row">
            <a href={providerWebsite} target="_blank" rel="noreferrer">
              {providerWebsite}
            </a>
          </div>
          <div className="openspider-free-model-warning-checkbox-row">
            <Checkbox
              onChange={(event) => {
