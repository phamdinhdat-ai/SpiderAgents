...
async def send_proactive_message_via_http(
    ...
    """Send a proactive message by directly calling the OpenSpider API."""
    ...
    try:
        ...
        logger.error(
            "Timeout (%ds) calling OpenSpider API for proactive message",
            timeout_seconds,
        )
    except Exception as e:
        logger.error("Error calling OpenSpider API for proactive message: %s", e)
