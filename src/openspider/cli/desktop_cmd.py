# -*- coding: utf-8 -*-
"""CLI command: run OpenSpider app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run OpenSpider app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing OpenSpider app instance.
    """
    ...
    click.echo(f"Starting OpenSpider app on {url} (port {port})")
